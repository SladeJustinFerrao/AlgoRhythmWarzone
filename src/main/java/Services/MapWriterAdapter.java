...
public class MapWriterAdapter extends MapFileWriter{
     ...
     */
    public void writeToFile(GameState p_gameState, FileWriter l_writer, String l_mapFormat) throws IOException {
        l_conquestMapWriter.writeToConquestFile(p_gameState, l_writer, l_mapFormat);
    }
}
